...
"""
Split 
./Multiple-Sclerosis-Brain-MRI-T1-master
  ├─images
  └─masks


 into test, train and valid sets.
...
if __name__ == "__main__":
  try:
    ...
    images_dir = "./Multiple-Sclerosis-Brain-MRI-master-" + dataset + "/images/"
    masks_dir  = "./Multiple-Sclerosis-Brain-MRI-master-" + dataset + "/masks/"
    output_dir = "./Multiple-Sclerosis-Brain-MRI-" + dataset + "-ImageMask-Dataset/"
